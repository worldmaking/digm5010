...
The term is borrowed from a [2011 article](https://worrydream.com/ExplorableExplanations/) by [Bret Victor](https://worrydream.com). Here's a couple of quotes that are highly relevant to our goals in this course:
...
This has inspired a whole ream of projects, including a collection of [Explorable Explanations at https://explorabl.es](https://explorabl.es). 
...
- Another collection, focused on [Complex Systems at www.complexity-explorables.org](https://www.complexity-explorables.org)
...
- An academic journal based on this format is [Distill](https://distill.pub) -- with a focus on ML. See the [about](https://distill.pub/about/) page.
- A platform for "repdroducible research" is [Nextjournal](https://nextjournal.com) -- see [examples](https://nextjournal.com/explore) -- "runs anything you can put into a Docker container"
- A platform for building observable data apps at [Observable](https://observablehq.com) -- see [examples](https://observablehq.com/explore) -- which runs mostly on D3.js. 
...
The paper should be prepared as typically required for a conference submission (see the [Call for Papers](#a-call-for-papers)). 
...
- Title
- Keywords
- Author (**Normally most conferences would request submission be anonymously submitted, but with our small group here this is not really viable**)
- Abstract
- Several major sections, beginning with an Introduction, ending with a Conclusion.
- List of references
...
- [The ISEA Word document template](https://isea2020.isea-international.org/wp-content/uploads/2019/09/Template-V2_ISEA2020.docx)
- [The SIGGRAPH Art Papers Word document template](https://www.acm.org/binaries/content/assets/publications/taps/acm_submission_template.docx)
- If you prefer to use LaTeX and Overleaf, here is [the SIGGRAPH article template](https://www.overleaf.com/latex/templates/association-for-computing-machinery-acm-sig-proceedings-template/bmvfhcdnxfty)
...
<iframe width="640" height="360" frameborder="0" src="https://www.shadertoy.com/embed/fltfDB" allowfullscreen></iframe>



https://www.shadertoy.com/embed/fltfDB?gui=true&t=10&paused=true&muted=false
