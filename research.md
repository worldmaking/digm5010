...
- Asking a question that nobody has asked before, *and which is worth answering*
- Doing the necessary work to respond to it, *and showing that it is done effectively/correctly*
- Communicating the knowledge you have acquired to a larger audience, *in a way that it can be built upon*

## Research is Sharing, Collaborative

As a member of the research community, you are building on the knowledge that others have acquired before you and providing a map for those who come after you. You are adding to a body of work that will never be complete.
