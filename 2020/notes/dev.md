...
Embed in a <div class="reveal"><div class="slides">, and use Reveal.initialize() in JS.
	Doesn't have to be stuck to the body element.

- Each slide is a <section data-auto-animate>
	- Nested <section>s become vertical slides
	- data-auto-animate means matching elements will css transform themselves smoothly between frames
	- it also animates matching list items and matching code block lines!

<aside> for slide notes

data-background-color
data-background-image (various options)
data-background-video (various options)
data-background-iframe (various options)

<small> for small text

<pre><code class="hljs" data-trim data-line-numbers> for code samples

data-line-numbers="|4,8-11|17|22-24" for highlighting specific lines with transitions

`class="fragment"` to pause and step through parts of a page
	- lots of variants here like fade-in, grow, highlight-red, etc.

various slide transitions

For end slides that are not part of the progress bar; <section data-visibility="uncounted"></section>
